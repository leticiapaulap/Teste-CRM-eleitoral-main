...
export const REFERRAL_ROLES = new Set([ROLES.COORDENADORES, ROLES.LIDERES, ROLES.CADASTRADOS]);
export const LOGIN_ROLES = new Set([ROLES.EQUIPE, ROLES.COORDENADORES]);
...
export function signToken(user) {
  ...
  if (!config.jwtSecret) throw new ApiError(500, "JWT_SECRET nao configurado.");
  return jwt.sign(
